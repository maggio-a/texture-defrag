...
static const char *fs_text[] = {
    ...
    "        else                                                          \n"
    "            texelColor = vec4(texture(img0, uv).rgb, 1);              \n"
    ...
    "        vec4 tex00 = texture(img0, vec2(h0.x, h0.y) / texture_size);  \n"
    "        vec4 tex10 = texture(img0, vec2(h1.x, h0.y) / texture_size);  \n"
    "        vec4 tex01 = texture(img0, vec2(h0.x, h1.y) / texture_size);  \n"
    "        vec4 tex11 = texture(img0, vec2(h1.x, h1.y) / texture_size);  \n"
